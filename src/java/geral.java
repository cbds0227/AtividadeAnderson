...
public class geral extends HttpServlet {
    ...
    try {
        ...
        if(op == 1){
                ...
                ps.execute(sql);
                out.println("<p>Cafastro realizado com sucesso.</ś><a href='/atividade'>Início");
        ...
        if(op == 2){
                ...
                ps.execute(sql2);
                out.println("<p>Cadastro realizado com sucesso.</p><a href='/atividade'>Início");
                }else{
                 out.println("<p>Verifique a conta</p><a href='/atividade'>Início");    
                }
        ...
        if(op == 3){
                 ...
                 while (r.next()) {
                  ...
                  out.println(html+"<br>Saldo total:"+soma+"<br><a href='/atividade'>Início");
